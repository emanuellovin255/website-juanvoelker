# Cóndor Dental Lab — sitio web

Sitio estático (HTML, CSS y JS) del Laboratorio Dental Cóndor. Sin dependencias ni compilación: abre `index.html` en el navegador.
...
- **Molar 3D del hero:** `tooth3d.js` (three.js r170, copiado en `assets/vendor/`). Sin WebGL se muestra la imagen fija `assets/fotos/diente-3d.webp`.
- **Formulario:** está en la cabecera (`#contacto`).
